        ...
        <main className={styles.tasksMainContent}>
                ...
                <div className={styles.taskCards}>
                    <div className={styles.taskCardItem}>
                        ...
                        <span role="columnheader" className={`${styles.name} ${styles.thead}`}>Name</span>
                        <span role="columnheader" className={`${styles.difficulty} ${styles.thead}`}>Difficulty</span>
                        <span role="columnheader" className={`${styles.solutions} ${styles.thead}`}>Solutions</span>
                    </div>
                ...
                <div className={styles.pagination}>
                    <button className={styles.arrowPrev} onClick={() => dispatch(prevPage())} disabled={currentPage === 0}></button>
                    <span>Page: <span className={styles.selectedPage}>{currentPage + 1}</span> of {totalPage}</span>
                    <button className={styles.arrowNext} onClick={() => dispatch(nextPage())} disabled={currentPage === totalPage - 1}></button>
                </div>
